...
namespace Automaton.Utils
{
    ...
    {
        private static int maxSecBeforeBurnout = Automaton.timeBeforeBurnout; //максимальное время в секундах до сгорания проводника
        private static int maxTicksBeforeBurnout = maxSecBeforeBurnout*Automaton.speedOfElectricity; //максимальное количество тиков до сгорания проводника 
