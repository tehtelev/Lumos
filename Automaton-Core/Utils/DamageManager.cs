...
namespace Automaton.Utils
{
    public class DamageManager
    {
        ...
        public static global::Automaton.Automaton? System;
        ...
        public DamageManager(ICoreServerAPI api)
        {
            ...
            // Получаем ссылку на систему Automaton, если она есть
            System = sapi!.ModLoader.GetModSystem<global::Automaton.Automaton>();
        }
            ...
            ICoreServerAPI sapi, Vec3d tmpPos, BlockPos pos)
        {
            ...
            if (sapi != null)
            {
                ...
                float precip = Automaton.WeatherSystemServer!.GetPrecipitation(tmpPos);
