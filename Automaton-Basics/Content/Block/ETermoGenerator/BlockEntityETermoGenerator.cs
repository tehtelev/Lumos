...
public class BlockEntityETermoGenerator : BlockEntityGenericTypedContainer, IHeatSource
{
    ...
    private BEBehaviorAutomaton? Automaton => GetBehavior<BEBehaviorAutomaton>();
    ...
    public static readonly float[] kpdPerHeight =
{
    ...
    public override void OnReceivedClientPacket(IPlayer player, int packetid, byte[] data)
    {
        ...
        Automaton?.OnReceivedClientPacket(player, packetid, data);
    }
    ...
    public override void OnReceivedServerPacket(int packetid, byte[] data)
    {
        ...
        Automaton?.OnReceivedServerPacket(packetid, data);
    }
    ...
    public override bool OnTesselation(ITerrainMeshPool mesher, ITesselatorAPI tesselator)
    {
        ...
        if (!MeshData.TryGetValue(sizeFuel, out var fuelMesh))
        {
            ...
            capi?.Tesselator.TesselateShape(this.Block, Vintagestory.API.Common.Shape.TryGet(Api, "automatonbasics:shapes/block/termogenerator/toplivo/toplivo-" + sizeFuel + ".json"), out fuelMesh);
    ...
    public override void ToTreeAttributes(ITreeAttribute tree)
    {
        ...
        tree.SetBytes("automaton:facing", SerializerUtil.Serialize(this.facing));
    }
    ...
    public override void FromTreeAttributes(ITreeAttribute tree, IWorldAccessor worldForResolving)
    {
        ...
        try
        {
            this.facing = SerializerUtil.Deserialize<Facing>(tree.GetBytes("automaton:facing"));
        }
